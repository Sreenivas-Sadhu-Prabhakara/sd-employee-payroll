package com.bank.bian.employeepayroll.model;
...
/**
 * The BIAN control record for this service domain: "Payroll Run Procedure".
 *
 ...
 * to its asset type (Payroll Run). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Payroll Run Procedure";
